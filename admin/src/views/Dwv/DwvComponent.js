...
class DwvComponent extends React.Component {
  ...
  componentDidMount() {
    ...
    console.log("app.addEventListener-->", app.addEventListener);
    // store
    ...
    return (
      <div id="dwv">
        ...
        <div className="layerContainer">
          <div className="dropBox">drop file here...</div>
          <canvas className="imageLayer" style={{ width: 1000 }}>
            solo para navegadores compatibles con html5...
          </canvas>
