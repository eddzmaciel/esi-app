...
class ViewForm extends Component {
    ...
    componentWillMount = async () => {
        ...
        if (location.state && location.state.client !== undefined) {
            this.setState({ formObject: location.state.client });
        } else {
            this.setState({
                formObject: {
                    businessName: '',
    ...
    onAdd = async () => {
        ...
        const clients = feathers.service('clients');
        if (formObject.title !== '') {
            try {
                if (location.state && location.state.client !== undefined) {
                    let recordId = location.state.client._id;
                    let recordToUpdate = {
                    ...
                    let updateRecord = await clients.patch(
                        recordId,
                        recordToUpdate
                    );
                    ...
                    let newRecord = await clients.create(formObject);
